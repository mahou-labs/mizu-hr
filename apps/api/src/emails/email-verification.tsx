          ...
          <Container className="mx-auto max-w-2xl px-4 py-8">
            ...
            <Section className="mb-6 rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
              <div className="mb-6 text-center">
                ...
                <Text className="text-gray-600 text-lg">Welcome to Mizu HR, {name}!</Text>
              </div>
            </Section>
            ...
            <Section className="text-center">
              <Text className="text-gray-500 text-xs leading-relaxed">
                This email was sent because an account was created with this email address on Mizu
                HR.
                <br />
